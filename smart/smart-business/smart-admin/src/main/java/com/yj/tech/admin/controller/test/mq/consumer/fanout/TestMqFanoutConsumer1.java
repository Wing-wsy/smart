 ...
 *
 *  注意：交换机名称都要一样 testExchangeFanout1，队列名称不一样： testQueueFanout1
 */
//@RabbitMq(exchangeTypes = FANOUT, exchange = "testExchangeFanout1", queues = "testQueueFanout1", consumersPerQueue = 2)
public class TestMqFanoutConsumer1 extends AbstractConsumer<String, String> {

    @Override
    public String handleMessage(String body) throws Exception {
        System.out.println("TestMqFanoutConsumer1 handleMessage......" + body);
        return null;
    }
    ...
    public void saveLog(String result, Message message, RabbitMqModel rabbitMqModel) {
        // TODO 消费数据成功后，记录日志操作
        System.out.println("TestMqFanoutConsumer1 saveLog......");
    }
}
